...
function IconHappiness({ className }: { className?: string }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function IconSatisfaction({ className }: { className?: string }) {
  return (
    <svg className={className} width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const NAV: { href: string; label: string; icon: ReactNode }[] = [
  { href: "/", label: "概要", icon: <IconDashboard /> },
  { href: "/happiness", label: "幸福統計", icon: <IconHappiness /> },
  { href: "/satisfaction", label: "満足度", icon: <IconSatisfaction /> },
  { href: "/insights", label: "改善ヒント", icon: <IconInsights /> },
  { href: "/users", label: "ユーザー管理", icon: <IconUsers /> },
  { href: "/billing", label: "課金管理", icon: <IconBilling /> },
];
